...
let Appointment = (_dec = (0, _typeorm.Entity)('appointments'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('uuid'), _dec3 = Reflect.metadata("design:type", String), _dec4 = (0, _typeorm.Column)(), _dec5 = Reflect.metadata("design:type", String), _dec6 = (0, _typeorm.ManyToOne)(() => _User.default), _dec7 = (0, _typeorm.JoinColumn)({
  ...
  constructor() {
    ...
    _initializerDefineProperty(this, "clocks_in", _descriptor5, this);

    _initializerDefineProperty(this, "clocks_out_lunch", _descriptor6, this);

    _initializerDefineProperty(this, "clocks_in_lunch", _descriptor7, this);

    _initializerDefineProperty(this, "clocks_out", _descriptor8, this);
  ...
  writable: true,
  initializer: null
}), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "clocks_in", [_dec11, _dec12], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "clocks_out_lunch", [_dec13, _dec14], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "clocks_in_lunch", [_dec15, _dec16], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "clocks_out", [_dec17, _dec18], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
